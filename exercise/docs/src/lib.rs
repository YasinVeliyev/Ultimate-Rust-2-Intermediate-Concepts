...
//! The term pumpkin is sometimes used interchangeably with "squash" or "winter squash", and is commonly used for cultivars of Cucurbita argyrosperma,
//! Cucurbita ficifolia, Cucurbita maxima, Cucurbita moschata, and Cucurbita pepo.
//! ![FrenchMarketPumpkinsB](https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/FrenchMarketPumpkinsB.jpg/700px-FrenchMarketPumpkinsB.jpg)
...
pub struct Pumpkin {
    /// `roundness` field, explaining that it is a percentage
    pub roundness: f32,
    /// `orangeness` field, explaining that it is a number from 8 to 27
    pub orangeness: i32,
}
