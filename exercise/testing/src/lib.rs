...
mod test {
    ...
    #[test]
    fn should_equal_to_4() {
        assert_eq!(sploosh(1, 2, 3), 4)
    }

    #[test]
    fn should_not_equal_to_4_with_params_5_6_7() {
        assert_ne!(sploosh(5, 6, 7), 4)
    }
    #[test]
    fn should_equal_to_99_if_first_value_is_neqative() {
    ...
    // - splish(9, 3) is 0
    #[test]
    fn should_be_neqative_with_params_100_10() {
        assert!(splish(100, 10) < 0)
    }

    #[test]
    fn should_be_postitive_with_params_40_20() {
        assert!(splish(40, 20) > 0)
    }
    #[test]
    fn should_be_zero_with_params_9_3() {
        assert!(splish(9, 3) == 0)
    }
}
